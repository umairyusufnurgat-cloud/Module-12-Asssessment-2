class ContactBookPlus {
    constructor() {
        ...
        this.backgroundImage = localStorage.getItem('backgroundImage') || null;
    ...
    bindEvents() {
        ...
        document.getElementById('bgImageInput').addEventListener('change', (e) => this.setBackgroundImage(e));
        ...
        document.getElementById('duplicateBtn').addEventListener('click', () => this.findDuplicates());
    ...
    setBackgroundImage(event) {
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                this.showToast('Background image updated!');
            };
    ...
    populateForm(contact) {
        ...
        document.getElementById('socialMedia').value = contact.socialMedia || '';
    ...
    findDuplicates() {
        ...
        this.contacts.forEach(contact => {
            const key = `${contact.firstName.toLowerCase()}_${contact.lastName.toLowerCase()}_${contact.email.toLowerCase()}`;
            if (seen.has(key)) {
                duplicates.push({ original: seen.get(key), duplicate: contact });
            } else {
        ...
        if (duplicates.length === 0) {
            ...
            this.showToast(`Found ${duplicates.length} potential duplicate(s)!`, 'warning');
